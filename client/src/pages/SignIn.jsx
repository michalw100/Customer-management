          ...
          <div className="flex-1">
            ...
            <div className="mt-8">
              ...
              {!isLoginPage && <p className="mt-6 text-sm text-center text-gray-400"
                ...
                you have an accunt?          
                <a href="#" className="text-blue-500 focus:outline-none focus:underline hover:underline"> Sign in</a>.
              </p>}
              {isLoginPage && <p className="mt-6 text-sm text-center text-gray-400"
                onClick={() => setIsLoginPage((prev) => !prev)}>
                Don't have an account yet? 
                <a href="#" className="text-blue-500 focus:outline-none focus:underline hover:underline"> Sign up</a>.
              </p>}
            </div>
          </div>
        </div>
